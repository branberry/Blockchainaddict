        ...
        <div>
          ...
          <form className="form-horizontal" onSubmit={this.handleSubmit}>
            <div className="form-group">
              ...
              <label htmlFor="inputTodoResponsible" className="col-sm-2 control-label">Goal Responsible</label>
              <div className="col-sm-10">
                <input
                       name="todoTitle"
                       type="text"
              ...
              <label htmlFor="inputTodoDescription" className="col-sm-2 control-label">Goal Description</label>
              <div className="col-sm-10">
                <textarea
                       name="todoTitle"
                       type="text"
                       ...
                       placeholder="Title"
                     />
                     <label htmlFor="inputTodoPrority" className="col-sm-2 control-label">Prority</label>
                     <div className="col-sm-10">
                       <select
                              name="todoPriority"
                              type="text"
